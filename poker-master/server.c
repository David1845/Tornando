...
#include "Poker.h"            // global constants
...
void getPokerMessage(char *buff,hands AllHands){
    ...
    for(int i =0; i < 6;i++){
        ...
        if(i == 0){
            sprintf(temp,"%d",AllHands[0].highCard);
        }else if(i == 1){
            sprintf(temp,"%d",AllHands[0].pair);
        }else if(i == 2){
            sprintf(temp,"%d",AllHands[0].twopair);
        }else if(i == 3){
            sprintf(temp,"%d",AllHands[0].tripes);
        }else if(i == 4){
            sprintf(temp,"%d",AllHands[0].straight);
        }else if(i == 5){
            sprintf(temp,"%d",AllHands[0].flush);
        }
